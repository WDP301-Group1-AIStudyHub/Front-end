...
const mockDocuments: AdminDocument[] = [
  {
    ...
    fileName: 'research-methods-analysis.pdf',
    filePublicId: 'mock/research-methods-analysis',
    fileSize: 4_200_000,
    fileType: 'application/pdf',
    fileUrl: 'https://example.com/research-methods-analysis.pdf',
    indexedStatus: 'indexed',
    ownerEmail: 'maya.research@university.edu',
    ownerName: 'Maya Iyer',
    subject: 'Astrophysics',
    title: 'Research Methods Analysis v2.4',
  ...
  },
  {
    ...
    fileName: 'neural-topologies-review.pdf',
    filePublicId: 'mock/neural-topologies-review',
    fileSize: 12_800_000,
    fileType: 'application/pdf',
    fileUrl: 'https://example.com/neural-topologies-review.pdf',
    indexedStatus: 'processing',
    ownerEmail: 'nora.ai@researchlab.edu',
    ownerName: 'Nora Patel',
    subject: 'AI Research',
    title: 'Neural Topologies Review',
