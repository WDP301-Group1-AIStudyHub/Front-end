...
import { remarkCitations } from "@/components/chat/sources/remarkCitations";
import { CitationMarker } from "@/components/chat/sources/CitationMarker";
...
const MarkdownTextImpl = () => {
  return (
    <MarkdownTextPrimitive
      ...
      className="aui-md"
      components={
        defaultComponents as unknown as React.ComponentProps<
...
const defaultComponents = {
  ...
  citation: ({ citationId, children }: { citationId?: number; children?: React.ReactNode }) => (
    <CitationMarker citationId={citationId}>{children}</CitationMarker>
  ),
};
