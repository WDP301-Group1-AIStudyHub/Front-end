...
export default function FlashcardStudy({ material, title }: FlashcardStudyProps) {
 ...
 <div className="mt-1 text-lg font-black text-emerald-600 ">{gotItCount}</div>
 </div>
 <div className="text-center border-x border-border/50">
 <div className="text-xs text-muted-foreground uppercase tracking-wide">Missed it</div>
 <div className="mt-1 text-lg font-black text-red-500 ">{missedItCount}</div>
 </div>
 <div className="text-center">
 ...
 <span className="ml-1.5 text-emerald-600 font-black">{gotItCount}</span>
 </div>
 <div>
 <span className="text-muted-foreground">Missed:</span>
 <span className="ml-1.5 text-red-500 font-black">{missedItCount}</span>
 </div>
 <div>
