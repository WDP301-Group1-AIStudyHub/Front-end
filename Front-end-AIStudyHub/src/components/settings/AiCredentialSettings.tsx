            ...
            {status && status.status === "invalid" && (
              <div className="rounded-md border border-warning/30 bg-warning/15 p-4 text-xs text-warning-foreground leading-relaxed flex items-start gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <p>
                    Your saved Google Gemini API key was rejected during
                    validation. Free quota rules apply until a working key is
                    provided. Please enter a valid key below to restore
                    unlimited access.
                  </p>
                </div>
              </div>
                ...
                <div className="flex flex-wrap gap-1.5 pt-1">
                  {(
                    ...
                    <Button
                      ...
                      type="button"
                      variant={
                        activeScenario === scenario ? "default" : "outline"
                      }
                      size="sm"
