...
export default function SplitInfoCard({
  ...
  return (
    <aside className="auth-split-glow celestial-card flex min-h-[430px] flex-col justify-between p-12">
      <div>
        <span className="mb-6 block text-xs font-semibold uppercase tracking-[0.2em] text-[var(--accent-gold)]">{eyebrow}</span>
        <h1 className="m-0 mb-6 text-[clamp(48px,5vw,64px)] font-[200] leading-none">{title}</h1>
